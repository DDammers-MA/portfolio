...
<header class="header header--project">
        <nav class="header__nav">
            <ul class="header__ul">
                <li class="header__li header__li--home"><a class="header__link header__link--pro " href="./index.php">Home</a></li>
                <li class="header__li"><a class="header__link header__link--pro" href="./projecten.php">Projecten</a></li>
                <li class="header__li"><a class="header__link header__link--pro" href="./index.php#AboutMe">About me</a></li>
                <li class="header__li header__li"><a class="header__link header__link--pro" href="./index.php#contact">Contact</a></li>
